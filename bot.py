...
try:
    ...
    if results_container:
        ...
        print(f"Trouvé {len(offres_list)} offres.")
        for offre_card in offres_list:
            ...
            if titre:
                ...
                def find_detail(card, alt_text):
                    ...
                    if img_tag and img_tag.parent: return img_tag.parent.text.strip()
                    return ""
                ...
                donnees_finales.append({
                    "titre": titre, "entreprise": entreprise, "contrat": contrat,
                    "salaire": salaire, "lieu": lieu, "url": lien_complet
                })
finally:
    driver.quit()
